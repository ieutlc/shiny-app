...
shinyUI(
  fluidPage(
    ...
    p(
      strong("Research & Design:"), HTML("&nbsp;"),
      a("Betsy Barre", href = "https://cat.wfu.edu/about/our-team/", target = "_blank"), HTML("&nbsp;|&nbsp;"),
      a("Allen Brown", href = "https://oe.wfu.edu/about/", target = "_blank"), HTML("&nbsp;|&nbsp;"),
      a("Justin Esarey", href = "http://www.justinesarey.com", target = "_blank"), br(),
      a("Click Here for Estimation Details", href = "http://www.cte.rice.edu/workload#howcalculated", target = "_blank"),
      align = "center"
    ),
